...
# allows us to use the functions and variables in the pygame.locals module without having to add the lengthy pygame.locals prefix

pygame.init()           # in order to use pygame library
...
# we use for it pygame.display.update()
# Game loop begins
